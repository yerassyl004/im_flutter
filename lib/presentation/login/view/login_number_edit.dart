...
class LoginNumberEdit extends StatelessWidget {
  const LoginNumberEdit({super.key});
            ...
            AnimatedPositioned(
              ...
              child: AnimatedSize(
                ...
                child: SizedBox(
                  height: 530.h,
                  child: Image.asset(
                    'assets/images/login_burger.png',
                  ),
                ),
              ),
            ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CountryNumberTextField(
                      ...
                      onChanged: (text) {
                        ...
                        if (number.length == 10) {
                          context.read<LoginBloc>().add(LoginEvent.sms(LoginData(number: number)));
                        }
                      },
                      onFinish: (text) {
                        final number = text.replaceAll(' ', '');
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Вход через', style: AppTextStyle.body18Medium()),
                          Spacer(),
                          Image.asset(
